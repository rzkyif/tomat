...
export const METADATA: ToolkitMetadata = {
  name: "AskUser Demo",
  description: "Walks through every variant of the askUser API.",
  tools: [
    {
      name: "askuser_demo",
      description:
        "Demonstrate the askUser flow: text input, single-select, multiselect with freeform input.",
      parameters: {
        type: "object",
        properties: {},
      },
      triggers: ["demo the ask user flow", "show me how askUser works", "run the form demo"],
      function: "demo",
    },
  ],
};
