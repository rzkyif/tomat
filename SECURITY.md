...
Thanks for taking the time to look at Tomat's security posture. This project is
a local-first desktop app; the interesting attack surface is mostly around
binary provenance, secret handling, and local IPC.
