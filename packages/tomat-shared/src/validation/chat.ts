...
export const chatStartWsSchema = z.object({
...
export const chatInterruptWsSchema = z.object({
...
export const toolAskUserResponseSchema = z.object({
...
export type ToolAskUserResponseFrame = z.infer<
  typeof toolAskUserResponseSchema
>;
